	...
	tuple_network_()
{
	...
	tuple_network_step2.load_tuple_network("tupleTable_after_1536");
	tuple_network_step3.load_tuple_network("tupleTable_after_3072_V3");
	//tuple_network_step4.load_tuple_network("tupleTable_after_3072And1536");
	//tuple_network_step5.load_tuple_network("tupleTable_after_3072And1536And768");
}
...
float ExpectiMax::expecti_max_random_turn( BitBoard board, int depth, bool& has_dead_board )
{
	...
	static float alpha = 1.0; //have tried 0.5~0.9
...
{
	//if(board.getMaxValueInBoard()>=13 && board.getScore()>= 300000)	// >= 3072 + 1536 + 768 = 255879
		//return tuple_network_step5.getBoard_value(board);
	//if(board.getMaxValueInBoard()>=13 && board.getScore()>= 236196)	// >= 3072 + 1536
		//return tuple_network_step4.getBoard_value(board);
	if(board.getMaxValueInBoard()>=13)	// >= 3072
		return tuple_network_step3.getBoard_value(board);
	if(board.getMaxValueInBoard()>=12)	// >= 1536
